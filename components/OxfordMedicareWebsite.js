    ...
    <div className="bg-[#0A0F3C] text-white" style={{ fontFamily: 'Palatino Linotype, serif' }}>
      ...
      <section className="bg-[#10194a] py-20 px-6 text-center">
        ...
        <p className="text-white max-w-2xl mx-auto mb-6">
          Join our global directory of professionals committed to equitable healthcare delivery.
        </p>
        <form className="max-w-xl mx-auto bg-white text-[#0A0F3C] rounded-2xl p-8 shadow space-y-4">
          <input type="text" placeholder="Full Name" required className="w-full p-3 rounded border border-gray-300" />
          <input type="email" placeholder="Email Address" required className="w-full p-3 rounded border border-gray-300" />
          <input type="text" placeholder="Expertise (e.g. Telemedicine, Public Health)" required className="w-full p-3 rounded border border-gray-300" />
          <textarea placeholder="Short Bio or Note (Optional)" className="w-full p-3 rounded border border-gray-300" rows="4" />
          <button type="submit" className="bg-[#74121D] text-white py-2 px-6 rounded-md font-semibold">
            Submit Profile
          </button>
        </form>
      </section>
